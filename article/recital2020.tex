...
qui a engagé en 2014 la numérisation de sa collection d'incunables et en 2015 celle de ses Mazarinades, sont ici exemplaires. 
...
\cite{Lejeune2019a}, pour le "corpus" des Mazarinades\footnote{Documents parus en France, lors de la Fronde (1648-1653).},
...
calculées grâce à des vérités de terrain, pour valider ou réfuter leur pertinence.
    ...
    pas d'estimer la qualité d'une sortie d'OCR, les auteurs se soucient du manque transcriptions à disposition
...
les modèles de langue appris et les mesures d'évaluation à comparer au \textit{CER}.
    ...
    Afin de réaliser l'océrisaion de ces images, deux logiciels ont été utilisés :
    \begin{itemize}
