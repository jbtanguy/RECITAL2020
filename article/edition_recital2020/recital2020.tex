...
\setmainfont{TeXGyreTermes-Regular}%[NFSSEncoding=PU]
...
\abstract{Language Model Based Evaluation of OCR Software Output Qualities for 17th Century French Documents}{
  ...
  to understand how these language model based estimations covary with the \textit{CER}, reference metric.\\
}
...
les modèles de langue appris et les mesures d'évaluation à comparer au \textit{CER}.
    ...
    \begin{itemize}
      \item \verb!Kraken!, version 2.0.8\footnote{\url{http://kraken.re/} et \url{https://pypi.org/project/kraken/}} (voir \cite{Kiessling2019a}) ;
      \item \verb!Tesseract!, version 0.3.3\footnote{\url{https://pypi.org/project/pytesseract/}} (voir \cite{Smith2007a}).
    \end{itemize}
        ...
        aux lignes segmentées et binarisées ainsi qu'un modèle \verb!Kraken! appris sur ces mêmes données\footnote{\url{https://github.com/e-ditiones/OCR17}}. 
        On dispose alors \textit{a priori} de deux modèles non adaptés aux documents de l'étude\footnote{Par exemple, le 
        <\mytextlongs > ne fait pas partie du vocabulaire des modèles de \texttt{Kraken} (anglais) et de \texttt{Tesseract} (français).} 
    ...
    \multicolumn{1}{c}{\textbf{Lignes Kraken}} & \multicolumn{1}{r}{\textbf{CER}} & \multicolumn{1}{c}{\textbf{Lignes Tesseract}} & \multicolumn{1}{r}{\textbf{CER}} & \multicolumn{1}{c}{\textbf{Lignes Kraken 17}}                                                            & \multicolumn{1}{r}{\textbf{CER}} \\
                                               & 100,0 \%                           &                                               & 100,0 \%                           & ¬                                                                                                        & 100,0 \%                           \\
    ...
    te, ny par confequent celle du             & 3,4 \%                         & te, ny par confequent celle du                & 3,4 \%                         & te, ny par con\mytextlongs equent celle du                                                  & 0 \%                             \\
    vaifeau oi elle ef : contre le             & 16,6 \%                        & vaiffeau où elle et : contre le               & 10 \%                            & vai\mytextlongs \mytextlongs eau ou elle elt: contre le                        & 6,6 \%                         \\
    fentiment de tous les Philofo-             & 6,8 \%                         & fentiment de tous les Philofo-                & 6,8 \%                         & \mytextlongs entiment de tous les Philo\mytextlongs o¬                         & 0 \%                             \\
    phes artifans: maislcau de-                & 14,8 \%                        & phes \& artifans: mais l'eau de-              & 7,4 \%                         & phes \& arti\mytextlongs ans. mais l’eau de¬                                                & 0 \%                             \\
    fcend de toutes lcs dcuxiam-               & 14,2 \%                        & fcend de toutes les deuxiam-                  & 7,1 \%                         & \mytextlongs cend de toutes les deux iam¬                                                   & 0 \%                             \\
    bes dans les dcux vaiffeaux,               & 11,1 \%                        & bes dans les deux vaiffeaux ,                 & 7,4 \%                         & bes dans les deux vai\mytextlongs \mytextlongs eaux,                           & 0 \%                             \\
    iufques a la mefme hauteur                 & 11,5\%                        & iufques à la mefme hauteur                    & 7,6 \%                         & iu\mytextlongs ques à la me\mytextlongs me hauteur                            & 3,8 \%                         \\
    ...
    puis la furface deleau de cha-             & 12,9 \%                        & puis la furface de l’eau de cha-              & 6,4 \%                         & puis la \mytextlongs urface de l’eau de cha¬                                                & 0 \%                             \\
    cun des vaiffcaux; Mais ayant              & 10,7 \%                        & cun des vaiffeaux; Maisayant                  & 10,7 \%                        & cun des vai\mytextlongs \mytextlongs eaux; Mais ayant                          & 0 \%                             \\
    inclin lc fiphon au deffous                & 17,8 \%                        & incliné le fiphon au deffous                  & 10,7 \%                        & incliné le \mytextlongs iphon au de\mytextlongs \mytextlongs ous & 3,7 \%                         \\
    ...
    iambe attirclcau qui eft dans              & 16,1 \%                        & jambe attire l'eau qui eft dans               & 9,6 \%                         & iambe attire l’eau qui e\mytextlongs t dans                                                 & 0 \%                             \\
    le vaifeau de la plus courte;              & 6,8 \%                         & le vaiffeau de la plus courtc;                & 10,3 \%                        & e vai\mytextlongs \mytextlongs eau de la plus courte;                          & 3,4 \%                         \\
    quand on le rehaufe au                     & 8,6 \%                         & \& quand on le rehaufle au                    & 8,6 \%                         & \& quand on le rehau\mytextlongs \mytextlongs e au                             & 0 \%                             \\
    ...
    \subsection{Métriques d'estimation}\label{metric}
    	...
    	\subsubsection{Préambules} 
		    ...
		    dans le corpus d'apprentissage du modèle de langue\footnote{Par exemple,  \texttt{Kraken} (anglais) et 
		    \texttt{Tesseract} (français), appris sur des documents contemporains, ont dans leur vocabulaire le symbole \euro{} et peuvent le proposer
...
probabilités pour estimer la qualité d'une sortie d'OCR sur des documents de la même période sont justifiés.
    ...
    \begin{center}
    \begin{scriptsize}
    \cprotect\bottomcaption{Corrélations et \textit{p-values} calculées entre les métriques d'estimation et le \textit{CER}.}
    \begin{supertabular}[H]{l||cc|cc|cc|cc}  

    \multicolumn{9}{c}{{\footnotesize OCR : Kraken (français contemporain). ML : probabilités conditionnelles.}}\\%\hline
    ...
    \multicolumn{9}{c}{{\footnotesize OCR : Tesseract (anglais contemporain). ML : probabilités conditionnelles.}}\\%\hline
    \multirow{2}{*}{\textbf{}} & \multicolumn{2}{c}{\textbf{S}}         & \multicolumn{2}{c}{\textbf{Pr}}        & \multicolumn{2}{c}{\textbf{PP}}        & \multicolumn{2}{c}{\textbf{log(PP)}}   \\ 
    & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} \\ %\hline
    ...
    \multicolumn{9}{c}{{\footnotesize OCR : Kraken (français XVII\ieme). ML : probabilités conditionnelles.}}\\%\hline
    \multirow{2}{*}{\textbf{}} & \multicolumn{2}{c}{\textbf{S}}         & \multicolumn{2}{c}{\textbf{Pr}}        & \multicolumn{2}{c}{\textbf{PP}}        & \multicolumn{2}{c}{\textbf{log(PP)}}   \\ 
    & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} \\ %\hline
    ...
    \multicolumn{9}{c}{{\footnotesize OCR : Kraken (français contemporain). ML : LSTM.}}\\%\hline
    \multirow{2}{*}{\textbf{}} & \multicolumn{2}{c}{\textbf{S}}         & \multicolumn{2}{c}{\textbf{Pr}}        & \multicolumn{2}{c}{\textbf{PP}}        & \multicolumn{2}{c}{\textbf{log(PP)}}   \\ 
    & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} \\ %\hline
    ...
    \multicolumn{9}{c}{{\footnotesize OCR : Tesseract (anglais contemporain). ML : LSTM.}}\\%\hline
    \multirow{2}{*}{\textbf{}} & \multicolumn{2}{c}{\textbf{S}}         & \multicolumn{2}{c}{\textbf{Pr}}        & \multicolumn{2}{c}{\textbf{PP}}        & \multicolumn{2}{c}{\textbf{log(PP)}}   \\ 
                               & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} \\ %\hline
    ...
    \multicolumn{9}{c}{{\footnotesize OCR : Kraken (français XVII\ieme). ML : LSTM.}}\\%\hline
    \multirow{2}{*}{\textbf{}} & \multicolumn{2}{c}{\textbf{S}}         & \multicolumn{2}{c}{\textbf{Pr}}        & \multicolumn{2}{c}{\textbf{PP}}        & \multicolumn{2}{c}{\textbf{log(PP)}}   \\ 
                               & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} \\ %\hline
    ...
    \multicolumn{9}{c}{{\footnotesize OCR : Kraken (français contemporain). ML : biLSTM.}}\\%\hline
    \multirow{2}{*}{\textbf{}} & \multicolumn{2}{c}{\textbf{S}}         & \multicolumn{2}{c}{\textbf{Pr}}        & \multicolumn{2}{c}{\textbf{PP}}        & \multicolumn{2}{c}{\textbf{log(PP)}}   \\ 
                               & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} \\ %\hline
    ...
    \multicolumn{9}{c}{{\footnotesize OCR : Tesseract (anglais contemporain). ML : biLSTM.}}\\%\hline
    \multirow{2}{*}{\textbf{}} & \multicolumn{2}{c}{\textbf{S}}         & \multicolumn{2}{c}{\textbf{Pr}}        & \multicolumn{2}{c}{\textbf{PP}}        & \multicolumn{2}{c}{\textbf{log(PP)}}   \\ 
                               & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} \\ %\hline
    ...
    \multicolumn{9}{c}{{\footnotesize OCR : Kraken (français XVII\ieme). ML : biLSTM.}}\\%\hline
    \multirow{2}{*}{\textbf{}} & \multicolumn{2}{c}{\textbf{S}}         & \multicolumn{2}{c}{\textbf{Pr}}        & \multicolumn{2}{c}{\textbf{PP}}        & \multicolumn{2}{c}{\textbf{log(PP)}}   \\ 
                               & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} & \textbf{corrélation} & \textbf{p-value} \\% \hline
